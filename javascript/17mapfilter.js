...
> it is use to apply the logic (add.sub.mul.divide.)

var a = [4,5,6,3,23,21,34,36,56,7,12,47,31,88]

a.map((data) => {return data*2}) /////// it fuction is also called as callback function
...
(14) [false, false, false, false, true, true, true, true, true, false, false, true, true, true]